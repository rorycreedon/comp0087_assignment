...
def download_extract_data(url, name):
	...
	with lzma.open("temp/" + folder + "/data/data.jsonl.xz") as f, open('temp/' + name + '.jsonl', 'wb') as f_out:
		file_content = f.read()
...
if __name__ == '__main__':
	...
	# Download New Mexico data
	url = "https://case.law/download/bulk_exports/latest/by_jurisdiction/case_text_open/nm/nm_text.zip"
	new_mexico_jsonl = download_extract_data(url, "nm_extracted")
	new_mexico_df = jsonl_to_df("nm_extracted").to_pickle("data/new_mexico.pkl")
